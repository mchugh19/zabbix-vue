...
<script>
import { Zabbix } from '/src/lib/zabbix-promise.js';
...
browser.storage.local.get("ZabbixServers").then((result) => {
  zabbix_data = result
  console.log("Options got zabbix_data: " + JSON.stringify(zabbix_data))
  ...
  methods: {
    ...
    save_data: function () {
      ...
      if (this.$refs.form.validate()) {
        ...
        browser.storage.local.set("ZabbixServers", ZabbixServers).then(() => {
